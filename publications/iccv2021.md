...
**Solver now available within a python package!** [Pylibmgm][pylibmgm_website]
...
Consider using our dedicated python package for the most up-to-date version available: [Pylibmgm][pylibmgm_website]
