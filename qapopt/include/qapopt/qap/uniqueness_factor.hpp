#ifndef LIBQAPOPT_QAP_UNIQUENESS_FACTOR_HPP
#define LIBQAPOPT_QAP_UNIQUENESS_FACTOR_HPP
...
class uniqueness_factor : public ::qapopt::unary_factor<ALLOCATOR> {
public:
  static constexpr cost initial_cost = 0;

  uniqueness_factor(index number_of_labels, const ALLOCATOR& allocator = ALLOCATOR())
  : ::qapopt::unary_factor<ALLOCATOR>::unary_factor(number_of_labels + 1, allocator)
  {
...
class gurobi_uniqueness_factor : public ::qapopt::gurobi_unary_factor<ALLOCATOR> {
public:
  using allocator_type = ALLOCATOR;
  using factor_type = uniqueness_factor<allocator_type>;

  gurobi_uniqueness_factor(factor_type& factor, GRBModel& model)
  : ::qapopt::gurobi_unary_factor<ALLOCATOR>(factor, model)
  { }
};
