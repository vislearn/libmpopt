#ifndef LIBMPOPT_MWIS_SOLVER_BREGMAN_LOG_HPP
#define LIBMPOPT_MWIS_SOLVER_BREGMAN_LOG_HPP

namespace mpopt {
namespace mwis {
namespace bregman_log {
...
protected:
  ...
  std::vector<cost> assignment_relaxed_, assignment_relaxed_best_;
  ...
  double threshold_feasibility_;
  double temperature_drop_factor_;
};

} // namespace mpopt::mwis::bregman_log
